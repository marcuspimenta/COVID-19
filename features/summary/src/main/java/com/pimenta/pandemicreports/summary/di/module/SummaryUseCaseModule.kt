...
import com.pimenta.pandemicreports.summary.domain.GetSummaryUseCase
 ...
 */
@Module
interface SummaryUseCaseModule {

    @Binds
    @ActivityScope
    fun providesGetSummaryUseCase(
        summaryUseCase: GetSummaryUseCase
